/* =============================================================================
   ...
   Campos de cada programa:
     ...
     foto               ruta a la foto real (ej. "img/programas/alimentacion.jpg"); null = imagen de referencia
   ...
   "galeria" de ese programa. No hace falta tocar HTML, CSS ni JS:
     "galeria": [
       "img/programas/alimentacion/1.jpg",
       "img/programas/alimentacion/2.jpg",
       "img/programas/alimentacion/3.jpg"
     ]
...
window.PARAISO503_CONTENT.programas = {
  ...
  "_ayuda_campos": {
    ...
    "foto": "ruta a la foto real del programa (ej. 'img/programas/alimentacion.jpg'). Déjalo en null para usar una imagen de referencia automática mientras no haya foto",
  ...
  "programas": [
    {
      ...
      "galeria": ["img/galeria/ruta1.jpg","img/galeria/ruta2.jpg","img/galeria/ruta3.jpg"]
    },
    {
      "id": "cancer",
      "icono": "fa-ribbon",
    ...
    },
    {
      ...
      "insignia": null,
      "etiquetaDestacado": null,
      "foto":"img/program/esterilizacion.jpg",
    ...
    },
    {
      ...
      "insignia": null,
      "etiquetaDestacado": null,
      "foto":"img/program/transparencia.jpg",
      "vistaInicio": "expandible",
      "enQueConsiste": [
    ...
    },
    {
      ...
      "insignia": null,
      "etiquetaDestacado": null,
      "foto":"img/program/rehabilitacion.jpg",
      "vistaInicio": "expandible",
      "enQueConsiste": [
    ...
    },
    {
      ...
      "insignia": null,
      "etiquetaDestacado": null,
      "foto":"img/program/voluntario.jpg",
      "vistaInicio": "expandible",
      "enQueConsiste": [
